...
var data = [
 ...
 },
 {
    ...
    function redraw() {
      ...
      var maxYear = new Date(2017,0,1,0,0,0);
      ...
      lines.append("line")
        ...
        lines.append("line")
        .attr("id", "start")
        .attr("x1", xz(markYear)-10)  //<<== change your code here
        .attr("y1", yz(146967)+50)
      ...
      //.classed('hidden',true)
      .html("Promise of financial incentives appears to have positively affected birth rate. Family 500 program is now officially law.")
        .style('left', (xz(startYear) - 80) + 'px')
